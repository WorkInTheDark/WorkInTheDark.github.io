...
My interdisciplinary background in Natural Language Processing (NLP) and Human-Computer Interaction (HCI) enables me to design AI systems that responsibly support real-world stakeholders' collaboration, empowering **human-AI collaboration** with **use-inspired AI**. Specifically, I propose human-centered NLP, a framework comprising three critical pillars: (i) uncovering real-world stakeholders’ collaboration workflow, (ii) developing domain-specific NLP models in low-resource environments, and (iii) designing human-centered systems into stakeholders’ workflow. 
